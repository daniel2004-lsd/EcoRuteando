// Agregar al archivo Icons.jsx existente
...
export const ReportIcon = ({ size = 24, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export const TicketIcon = ({ size = 24, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
// Agrega estos exports al final del archivo Icons.jsx
