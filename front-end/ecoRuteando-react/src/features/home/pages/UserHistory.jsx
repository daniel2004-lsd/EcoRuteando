...
const UserHistory = ({ onNavigate }) => {
    ...
    const totalCO2 = history.reduce((sum, route) => sum + parseFloat(route.co2), 0).toFixed(2);
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <span className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>{route.origin}</span>
                                        <span className="text-gray-400">→</span>
                                        <MapPinIcon size={18} className="text-emerald-500" />
                                        <span className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>{route.destination}</span>
                                    </div>
                                    <div className="flex flex-wrap gap-4 text-sm">
                                        ...
                                        <div className="flex items-center gap-1 text-emerald-500">
                                            <LeafIcon size={14} />
                                            <span className="font-medium">{route.co2}</span>
                                        </div>
                                        <div className={`flex items-center gap-1 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
